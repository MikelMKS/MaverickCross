...
<table id="Dtable" class="styled-table" style="width:100%">
    <thead>
        <tr>
            <th class="col" style="width: 10% !important;" data-toggle="tooltip" data-placement="top" title="ID">ID</th>
            <th class="col" style="width: 50% !important;">NOMBRE</th>
            <th class="col" style="width: 10% !important;">DIRECCION</th>
            <th class="col" style="width: 10% !important;">CANTIDAD</th>
            <th class="col" style="width: 10% !important;">FECHA</th>
            <th class="col" style="width: 10% !important;">PRECIO</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
function contador(Dtable) {
    $('#c'+c_ID).html(number_format(Dtable.column(c_ID,{filter: 'applied'}).data().unique().filter(function(value, index){return value != "" ? true : false;}).count()));
}
// ///////////////////////////////////////////////////////////////////////
</script>
@endsection